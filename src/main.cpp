...
uint256 hashGenesisBlock("0xe5cd2e5569054da0e955bf740a1e645f81caee822ccc9656e8bb1411d49165dd");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(508436401); // Kricoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Kricoin Signed Message:\n";
...
{
    // Kricoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 1680000); // Kricoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 216000; // Kricoin: 3.5 days
static const int64 nTargetSpacing = 60; // Kricoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Kricoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Kricoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Kricoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf95223d8d296547b8346dd8fe35e4da8a305f10cc3c474e15bcc2454d7bac75b");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Naaaa es magnifico";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 10000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("62e6c50c93e5aa22cae73b9f5fe64d440b44812038e4615f50c5eb9d76d3ce702aa5ec82498f2816d66ce51630c17f4c66998bd4f4eb0a700fbf72733c75c18d29") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1751683437;
        block.nBits    = 508436401;
        block.nNonce   = 1624872280;

        if (fTestNet)
        {
            block.nTime    = 1751683437;
            block.nNonce   = 2956932346;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x91f2c027004739e02f24eda2d3a4dd18bfd48e87b679bee20071d15d58ab52e8"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Kricoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("KricoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("KricoinMiner : ProcessBlock, block not accepted");
    }
